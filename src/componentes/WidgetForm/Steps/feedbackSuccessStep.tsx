...
interface FeedbackSuccessStepProp {
    onFeedbackTypeChangedBack: (type: boolean) => void;
}


export function FeedbackSuccessStep({ onFeedbackTypeChangedBack }: FeedbackSuccessStepProp) {
    return (
        <>
            <header>
                <CloseButton />
            ...
            <div className="flex flex-col items-center py-10 w-[304px]">
                ...
                <button
                    ...
                    onClick={() => { onFeedbackTypeChangedBack(false) }}
                >
                    Quero enviar outro!!
                </button>
